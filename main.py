    ...
    def my_app(cfg: DictConfig) -> None:
        ...
        def train(epoch):
            ...
            for batch_idx, (inputs, targets) in enumerate(trainloader):
                ...
                #Se suben las metricas obtnidas del training############################################################
                mlflow.log_metric(key="epoch", value=2*train_iteration, step= epoch)
                mlflow.log_metric("loss", train_loss)
                mlflow.log_metric("acurracy", 100. * correct / total)
                ########################################################################################################
